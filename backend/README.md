...
- **Development**: Requires PostgreSQL for conversation persistence
- **Required**: PostgreSQL is mandatory - no fallback to in-memory checkpointer

**Development**: PostgreSQL is required for all conversation persistence.
